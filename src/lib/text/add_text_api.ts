...
import type { SubmissionText } from "$lib/speech/submission_text"

export class AddTextApi {
	private readonly _api_path: ApiPath

	public constructor(language_code: SpeechLanguageCode, speech_text: SubmissionText, private readonly _origin = '') {
