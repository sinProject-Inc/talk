...
export class Repository {
	...
	public static app_setting = new AppSettingRepositoryPrisma(this._context)
	...
	public static language: LanguageRepository = new LanguageRepositoryPrisma(this._context)
