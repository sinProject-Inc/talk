...
export class LocaleSeeder {
	private static readonly _seeds: LocaleSeed[] = [
		...
		{ code: 'gl-ES', language: 'Galego', country: 'España', emoji: '🇪🇸' },
		{ code: 'it-IT', language: 'Italiano', country: 'Italia', emoji: '🇮🇹' },
		{ code: 'lv-LV', language: 'Latviešu', country: 'latviešu', emoji: '🇱🇻' },
		{ code: 'lt-LT', language: 'Lietuvių', country: 'Lietuva', emoji: '🇱🇹' },
		{ code: 'hu-HU', language: 'Magyar', country: 'Magyarország', emoji: '🇭🇺' },
		{ code: 'nl-NL', language: 'Nederlands', country: 'Nederland', emoji: '🇳🇱' },
		{ code: 'nb-NO', language: 'Norsk bokmål', country: 'Norge', emoji: '🇳🇴' },
		{ code: 'pl-PL', language: 'Polski', country: 'Polska', emoji: '🇵🇱' },

		{ code: 'pt-BR', language: 'Português', country: 'Brasil', emoji: '🇧🇷' },
		{ code: 'pt-PT', language: 'Português', country: 'Portugal', emoji: '🇵🇹' },

		{ code: 'ro-RO', language: 'Română', country: 'România', emoji: '🇷🇴' },
		{ code: 'sk-SK', language: 'Slovenčina', country: 'Slovensko', emoji: '🇸🇰' },
		{ code: 'fi-FI', language: 'Suomi', country: 'Suomi', emoji: '🇫🇮' },
